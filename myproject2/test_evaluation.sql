...
--
-- Host: localhost    Database: test_evaluation
-- ------------------------------------------------------
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `delete_country`
BEFORE DELETE ON `Country`
FOR EACH ROW
BEGIN
  DELETE FROM City WHERE OLD.Code = CountryCode ; 
  DELETE FROM CountryLanguage WHERE OLD.Code = CountryCode;
END */;;
DELIMITER ;
...
DROP TABLE IF EXISTS `admin_deatails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `admin_deatails` WRITE;
/*!40000 ALTER TABLE `admin_deatails` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin_deatails` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `log_details` (
  ...
  `browser_detail` varchar(150) NOT NULL,
  `port` varchar(10) NOT NULL,
  `machine_name` varchar(20) NOT NULL,
  `user_id` int(5) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `log_details_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `question_bank` (
  ...
  `questions` varchar(254) NOT NULL,
  `answer` varchar(5) NOT NULL,
  `status` enum('1','0') NOT NULL,
  `type` tinyint(1) NOT NULL COMMENT '1 for multiple choice and 0 for true/false',
  `created_on` date NOT NULL,
  `updated_on` date NOT NULL,
  PRIMARY KEY (`id`),
  KEY `subject_id` (`subject_id`),
  CONSTRAINT `question_bank_ibfk_1` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `question_option` (
  ...
  PRIMARY KEY (`id`),
  KEY `ques_id` (`ques_id`),
  CONSTRAINT `question_option_ibfk_1` FOREIGN KEY (`ques_id`) REFERENCES `question_bank` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `temporary_test`
--

DROP TABLE IF EXISTS `temporary_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `temporary_test` (
  `test_id` int(11) NOT NULL,
  `ques_id` int(5) NOT NULL,
  `user_answer` varchar(5) NOT NULL,
  PRIMARY KEY (`test_id`,`ques_id`),
  KEY `ques_id` (`ques_id`),
  CONSTRAINT `temporary_test_ibfk_2` FOREIGN KEY (`ques_id`) REFERENCES `question_bank` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `temporary_test_ibfk_1` FOREIGN KEY (`test_id`) REFERENCES `tests` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `temporary_test`
--

LOCK TABLES `temporary_test` WRITE;
/*!40000 ALTER TABLE `temporary_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `temporary_test` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `test_history` (
  ...
  `certificate_id` varchar(50) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `test_id` (`test_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `test_history_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user_details` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `test_history_ibfk_2` FOREIGN KEY (`test_id`) REFERENCES `tests` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tests` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `subject_id` int(11) NOT NULL,
  `total_ques` int(5) NOT NULL,
  `created_by` int(5) NOT NULL,
  `created_on` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `created_by` (`created_by`),
  CONSTRAINT `tests_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `admin_deatails` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='admin_id would be  used as created_by ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_details` (
  ...
  CONSTRAINT `user_details_ibfk_1` FOREIGN KEY (`country_code`) REFERENCES `Country` (`Code`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `users_ibfk_4` FOREIGN KEY (`id`) REFERENCES `user_details` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `users_ibfk_3` FOREIGN KEY (`id`) REFERENCES `admin_deatails` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-03-05 20:54:42
